    ...
    <div class="es_content_in">
        ...
        <div class="es_dashboard_menu clearFix">
        	<ul>
                ...
                <li><a href="<?php echo admin_url()?>admin.php?page=es_agents"><span></span><?php _e( "Agent Info", "es-plugin" ); ?></a></li>
        ...
        <div class="es_dashboard_get_support clearFix">
        	<ul>
                ...
                <li><a href="https://www.youtube.com/channel/UCHhq46H033xh7XLsV8GqY3Q/playlistshttp://"><span></span><?php _e( "Video Tutorial", "es-plugin" ); ?></a></li>
