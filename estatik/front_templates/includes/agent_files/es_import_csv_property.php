...
if(isset($_FILES['prop_csv']) && $_FILES['prop_csv']!=""){
    ...
    if(in_array($ext,$allowed) ) {
        ...
        if (($handle = fopen($prop_csv['tmp_name'], "r")) !== FALSE) {
            while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
                ...
                if($row>2){
                    ...
                    $message  = "Property #$post_id is added, please check it <a href='".admin_url()."admin.php?page=es_my_listings'>here</a> and approve.";
        ...
        if(isset($_POST['es_prop_save_close'])){
            ...
            wp_redirect(home_url().'/'.$slug.'/?added=1'); exit;
        }
    }
}
...
<div class="es_wrapper">
    <form method="post" enctype="multipart/form-data" id="es_prop_insertion" action="">
        <h1 class="es_mainHeading"><?php _e( "Add New Properties", "es-plugin" ); ?></h1>
