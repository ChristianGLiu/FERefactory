        ...
        <form method="get" action="<?php echo $search_page_url; //home_url(); ?>/">
            ...
            <div class="es_my_listing_search_lower clearfix">
                <?php 
                    ...
                    if ( $search_price == 1 ) { 
                        es_search_input_min_max(__("Price", 'es-plugin'), 'price'); 
                    }
                    if ( $search_bedrooms == 1 ) {
                        es_search_input_min_max(__("Bedrooms", 'es-plugin'), 'bedrooms'); 
                    } 
                    if ( $search_bathrooms == 1 ) {
                        es_search_input_min_max(__("Bathrooms", 'es-plugin'), 'bathrooms'); 
                    } 
                    if ( $search_sqft == 1 ) {
                        ...
                        es_search_input_min_max($title, 'area'); 
                    } 
                    if ( $search_lotsize == 1 ) {
                        es_search_input_min_max(__("Lot size", 'es-plugin'), 'lotsize'); 
                    }
